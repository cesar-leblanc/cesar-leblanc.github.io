...
3. creating a foundation model capable of getting a syntaxic understanding of plant species patterns (see [framework](https://github.com/cesar-leblanc/plantbert) and [paper](https://www.nature.com/articles/s41477-025-02105-7))
4. using predicted species assemblages to map and monitor European habitats, while providing biodiversity indicators (see [website](https://geo.plantnet.org/) and [paper](https://openaccess.thecvf.com/content/CVPR2025W/EarthVision/papers/Leblanc_Mapping_biodiversity_at_very-high_resolution_in_Europe_CVPRW_2025_paper.pdf))
...
Since the beginning of the PhD in 2022, my results have been published in 18 articles or papers, presented in 7 conferences or congresses, introduced in 16 seminars or workshops, implemented in 5 frameworks or softwares, and popularized in 1 post or entry.
